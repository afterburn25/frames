...
R25J_SHA='bccff173bc151d8fbd6e8f8c691e43124b8813bcf34cbae63bd407366d6f55ca'
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='r25probe-') as td:
        ...
        rr=run(['python3',ROOT/'tools/ci/patch_v108_r25j_multidevice_event_dispatch.py',F/'kernel/main.nx'],stdout=subprocess.PIPE); req(sha(F/'kernel/main.nx')==R25J_SHA,'r25j identity'); shutil.copy2(F/'kernel/main.nx',ROOT/'probe-evidence/kernel-r25j.nx'); (ROOT/'probe-evidence/R25J-SHA.txt').write_text(rr.stdout)
