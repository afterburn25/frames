...
one('8b236b8b21a181e5db9fbeec3c5b64840df0d3158980bde3176647e6cf651bc8','733b8f94d26360494c0035236c840a31e18c1dfa5af7eaf638823e04fc6d2ba7','exact r59n identity target')
...
try:
    ...
    for q in ('volatile_read64(xhci+3880)','volatile_read64(xhci+3888)','fls=(c/4)%4','fi=(fr/8)%1024','volatile_read32(frame+(fi*4))==qlo+2','volatile_read32(dm+12)==tdlo','(ot/128)%2'):
