...
for q in ['fls=(c/4)%4','fi=(fr/8)%1024','volatile_read32(frame+(fi*4))==qlo+2','volatile_read32(dm+12)==tdlo','(ot/128)%2','(volatile_read32(op+4)/16384)%2','volatile_read64(xhci+3976)','sm=qi%256','cm=(qi/256)%256']:
...
EXPECTED='f7c853be4d96868b44f263a797eafcb07be95c378baf50644276f35d836e0950'
