...
# the already-certified redraw budget. Preserve historical r32 unchanged and use
# a private compatibility copy whose gate checks the underlying state writes.
