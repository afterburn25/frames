...
one("'volatile_write64(xhci_state+3984,hit)'", "'volatile_write64(xhci_state+3984,volatile_read64(xhci_state+3984)+1)'", 'r59o longitudinal sample-counter witness adapter')
