...
def main():
    ...
    result={'status':'FAIL','gate':'r17_desktop_interaction','iso_sha256':sha256(a.iso),'tap_selftest':False,'bottom':False,'context':False,'drag':False}
    ...
    try:
        ...
        goto(70,110); btn('right',True); time.sleep(.08); btn('right',False); time.sleep(.15)
