...
if len(sys.argv) != 2:
    raise SystemExit('usage: patch_uefi_splash.py PATH_TO_frames_boot.c')
p = Path(sys.argv[1])
raw = p.read_bytes()
expected = '8a35e0f3bdbfab8f9e166cae1ad308d28f906226919f86e60deedb4148b19f9d'
actual = hashlib.sha256(raw).hexdigest()
if actual != expected:
    raise SystemExit(f'unexpected loader hash: {actual}')
s = raw.decode('utf-8')
...
p.write_text(s)
print('patched Frames UEFI loader with GOP splash support')
